...
var t, n, o = l(e), i = o[0], c = o[1], a = new s(u(0, i, c)), f = 0, h = c > 0 ? i - 4 : i;
for (n = 0; n < h; n += 4) {
...
if (t >= n) return 1;
if (this === e) return 0;
for (var s = (r >>>= 0) - (o >>>= 0), i = (n >>>= 0) - (t >>>= 0), c = Math.min(s, i), l = this.slice(o, r), u = e.slice(t, n), f = 0; f < c; ++f) if (l[f] !== u[f]) {
s = l[f];
i = u[f];
break;
}
...
if (r) {
var u = -1;
for (s = n; s < c; s++) if (l(e, s) === l(t, -1 === u ? 0 : s - u)) {
-1 === u && (u = s);
if (s - u + 1 === a) return u * i;
} else {
-1 !== u && (s -= s - u);
u = -1;
}
...
n + a > c && (n = c - a);
for (s = n; s >= 0; s--) {
for (var f = !0, h = 0; h < a; h++) if (l(e, s + h) !== l(t, h)) {
f = !1;
break;
}
if (f) return s;
...
a = e[r + 1];
l = e[r + 2];
128 == (192 & a) && 128 == (192 & l) && (f = (15 & s) << 12 | (63 & a) << 6 | 63 & l) > 2047 && (f < 55296 || f > 57343) && (i = f);
break;
...
l = e[r + 2];
u = e[r + 3];
128 == (192 & a) && 128 == (192 & l) && 128 == (192 & u) && (f = (15 & s) << 18 | (63 & a) << 12 | (63 & l) << 6 | 63 & u) > 65535 && f < 1114112 && (i = f);
}
}
if (null === i) {
i = 65533;
...
var J = /[^+\/0-9A-Za-z-_]/g;
function z(e) {
if ((e = V(e).replace(J, "")).length < 2) return "";
for (;e.length % 4 != 0; ) e += "=";
return e;
}
function V(e) {
...
var s, i, c = 8 * r - o - 1, a = (1 << c) - 1, l = a >> 1, u = -7, f = n ? r - 1 : 0, h = n ? -1 : 1, d = e[t + f];
f += h;
s = d & (1 << -u) - 1;
d >>= -u;
u += c;
for (;u > 0; s = 256 * s + e[t + f], f += h, u -= 8) ;
i = s & (1 << -u) - 1;
s >>= -u;
u += o;
for (;u > 0; i = 256 * i + e[t + f], f += h, u -= 8) ;
if (0 === s) s = 1 - l; else {
...
var i, c, a, l = 8 * s - r - 1, u = (1 << l) - 1, f = u >> 1, h = 23 === r ? Math.pow(2, -24) - Math.pow(2, -77) : 0, d = o ? 0 : s - 1, p = o ? 1 : -1, y = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
t = Math.abs(t);
...
8: [ function(e, t) {
"use strict";
var n = e("./../utils"), o = e("./../core/settle"), r = e("./../helpers/cookies"), s = e("./../helpers/buildURL"), i = e("../core/buildFullPath"), c = e("./../helpers/parseHeaders"), a = e("./../helpers/isURLSameOrigin"), l = e("../core/createError");
...
p.onabort = function() {
if (p) {
u(l("Request aborted", e, "ECONNABORTED", p));
p = null;
}
};
p.onerror = function() {
...
u(l(t, e, e.transitional && e.transitional.clarifyTimeoutError ? "ETIMEDOUT" : "ECONNABORTED", p));
p = null;
};
...
var u = r.concat(s).concat(i).concat(c), f = Object.keys(e).concat(Object.keys(t)).filter(function(e) {
...
for (var o = 0, s = arguments.length; o < s; o++) l(arguments[o], n);
return t;
},
...
n.Socket = void 0;
const r = e("./transports/index.js"), s = e("./util.js"), i = e("./contrib/parseqs.js"), c = e("./contrib/parseuri.js"), a = o(e("debug")), l = e("@socket.io/component-emitter"), u = e("engine.io-parser"), f = (0, 
a.default)("engine.io-client:socket");
class h extends l.Emitter {
constructor(e, t = {}) {
super();
...
const r = e("../transport.js"), s = o(e("debug")), i = e("../contrib/yeast.js"), c = e("../contrib/parseqs.js"), a = e("engine.io-parser"), l = e("./xmlhttprequest.js"), u = e("@socket.io/component-emitter"), f = e("../util.js"), h = e("../globalThis.js"), d = (0, 
...
n.WS = void 0;
const r = e("../transport.js"), s = e("../contrib/parseqs.js"), i = e("../contrib/yeast.js"), c = e("../util.js"), a = e("./websocket-constructor.js"), l = o(e("debug")), u = e("engine.io-parser"), f = (0, 
l.default)("engine.io-client:websocket"), h = "undefined" != typeof navigator && "string" == typeof navigator.product && "reactnative" === navigator.product.toLowerCase();
...
(0, u.encodePacket)(o, this.supportsBinary, e => {
const n = {};
...
n.decode = e => {
let t, n, o, s, i, c = .75 * e.length, a = e.length, l = 0;
if ("=" === e[e.length - 1]) {
c--;
"=" === e[e.length - 2] && c--;
}
const u = new ArrayBuffer(c), f = new Uint8Array(u);
for (t = 0; t < a; t += 4) {
n = r[e.charCodeAt(t)];
...
if ("number" === f && isFinite(e)) return t.long ? (i = e, (c = Math.abs(i)) >= s ? u(i, c, s, "day") : c >= r ? u(i, c, r, "hour") : c >= o ? u(i, c, o, "minute") : c >= n ? u(i, c, n, "second") : i + " ms") : l(e);
...
C(_.prototype);
a(_.prototype, i, function() {
return this;
});
e.AsyncIterator = _;
e.async = function(t, n, o, r, s) {
void 0 === s && (s = Promise);
var i = new _(l(t, n, o, r), s);
...
var a = o.call(i, "catchLoc"), l = o.call(i, "finallyLoc");
if (a && l) {
...
t = t || {};
const n = r.url(e, t.path || "/socket.io"), o = n.source, i = n.id, l = n.path, u = a[i] && l in a[i].nsps;
let f;
if (t.forceNew || t["force new connection"] || !1 === t.multiplex || u) {
...
n.Manager = void 0;
const c = e("engine.io-client"), a = e("./socket.js"), l = s(e("socket.io-parser")), u = e("./on.js"), f = e("./contrib/backo2.js"), h = e("@socket.io/component-emitter"), d = i(e("debug")).default("socket.io-client:manager");
...
n.__esModule = !0;
n.receiveduserlist = n.receivedUserbyID = n.deleteuser = n.createUser = void 0;
e("regenerator-runtime/runtime");
...
var s = e("axios-creator").default, i = "https://chinese-chess-vnp.herokuapp.com/api/player", c = function() {
...
for (var l = 0; l < r.length; l++) 1 == r[l].active && (r[l].active = !1);
i.pauseSystemEvents(!0);
for (l = 0; l < r.length; l++) {
if (r[l].y <= e.redriver) {
if (r[l].x == self.node.x + 2 * e.s && r[l].y == self.node.y + 2 * e.s) {
r[l].active = !0;
for (var u = 0; u < s.length; u++) s[u].x == self.node.x + e.s && s[u].y == self.node.y + e.s && (r[l].active = !1);
for (var f = 0; f < c.length; f++) c[f].x == self.node.x + e.s && c[f].y == self.node.y + e.s && (r[l].active = !1);
}
if (r[l].x == self.node.x - 2 * e.s && r[l].y == self.node.y + 2 * e.s) {
r[l].active = !0;
for (u = 0; u < s.length; u++) s[u].x == self.node.x - e.s && s[u].y == self.node.y + e.s && (r[l].active = !1);
for (f = 0; f < c.length; f++) c[f].x == self.node.x - e.s && c[f].y == self.node.y + e.s && (r[l].active = !1);
}
if (r[l].x == self.node.x + 2 * e.s && r[l].y == self.node.y - 2 * e.s) {
r[l].active = !0;
for (u = 0; u < s.length; u++) s[u].x == self.node.x + e.s && s[u].y == self.node.y - e.s && (r[l].active = !1);
...
for (u = 0; u < s.length; u++) s[u].x == r[l].x && s[u].y == r[l].y && (r[l].active = !1);
for (f = 0; f < c.length; f++) c[f].x == r[l].x && c[f].y == r[l].y && 1 == r[l].active && r[l].setScale(e.scale, e.scale);
}
t.redtouchmove(l);
}
},
...
for (var u = 0; u < s.length; u++) if (self.node.y < s[u].y && s[u].y < s[a].y && s[u].x == self.node.x) {
o[c].active = !0;
break;
}
if (0 == o[c].active) for (u = 0; u < i.length; u++) if (self.node.y < i[u].y && i[u].y < s[a].y && i[u].x == self.node.x) {
o[c].active = !0;
break;
}
...
for (u = 0; u < s.length; u++) if (self.node.x < s[u].x && s[u].x < s[a].x && s[u].y == self.node.y) {
o[c].active = !0;
break;
}
if (0 == o[c].active) for (u = 0; u < i.length; u++) if (self.node.x < i[u].x && i[u].x < s[a].x && i[u].y == self.node.y) {
o[c].active = !0;
break;
}
...
if (o[c].x == self.node.x && o[c].y < self.node.y) for (a = 0; a < s.length; a++) if (o[c].x == s[a].x && o[c].y == s[a].y) {
for (u = 0; u < i.length; u++) if (self.node.y > i[u].y && i[u].y > s[a].y && i[u].x == self.node.x) {
o[c].active = !0;
break;
}
if (0 == o[c].active) for (u = 0; u < s.length; u++) if (self.node.y > s[u].y && s[u].y > s[a].y && s[u].x == self.node.x) {
o[c].active = !0;
break;
}
...
if (o[c].y == self.node.y && o[c].x < self.node.x) for (a = 0; a < s.length; a++) if (o[c].x == s[a].x && o[c].y == s[a].y) {
for (u = 0; u < i.length; u++) if (self.node.x > i[u].x && i[u].x > s[a].x && i[u].y == self.node.y) {
o[c].active = !0;
break;
}
if (0 == o[c].active) for (u = 0; u < s.length; u++) if (self.node.x > s[u].x && s[u].x > s[a].x && s[u].y == self.node.y) {
o[c].active = !0;
break;
}
...
for (var u = 0; u < r.length; u++) if (self.node.y < r[u].y && r[u].y < i[l].y && r[u].x == self.node.x) {
o[c].active = !0;
break;
}
if (0 == o[c].active) for (u = 0; u < i.length; u++) if (self.node.y < i[u].y && i[u].y < i[l].y && i[u].x == self.node.x) {
o[c].active = !0;
break;
}
...
for (u = 0; u < r.length; u++) if (self.node.x < r[u].x && r[u].x < i[l].x && r[u].y == self.node.y) {
o[c].active = !0;
break;
}
if (0 == o[c].active) for (u = 0; u < i.length; u++) if (self.node.x < i[u].x && i[u].x < i[l].x && i[u].y == self.node.y) {
o[c].active = !0;
break;
}
...
for (c = o.length - 1; c >= 0; c--) {
if (o[c].x == self.node.x && o[c].y < self.node.y) for (l = 0; l < i.length; l++) if (o[c].x == i[l].x && o[c].y == i[l].y) {
for (u = 0; u < r.length; u++) if (self.node.y > r[u].y && r[u].y > i[l].y && r[u].x == self.node.x) {
o[c].active = !0;
break;
}
if (0 == o[c].active) for (u = 0; u < i.length; u++) if (self.node.y > i[u].y && i[u].y > i[l].y && i[u].x == self.node.x) {
...
t = n;
var r = e.namedisplay;
(0, o.receivedUserbyID)(t).then(function(e) {
...
for (var l = 0; l < s.length; l++) s[l].x == o[c].x && s[l].y == o[c].y && 1 == o[c].active && o[c].setScale(e.scale, e.scale);
t.blacktouchmove(c);
}
},
start: function() {}
...
uid = n;
e.namedisplay;
(0, o.receivedUserbyID)(uid).then(function(e) {
...
r.on("receiveduserID", function(n) {
e(n);
t("something wrong");
});
});
...
r.on("receivedroomID", function(n) {
...
r.emit("sendChessPosition", e);
};
n.receivedchessPosition = function() {
return new Promise(function(e, t) {
r.once("receivedChessPosition", function(n) {
s.push(n[n.length - 1]);
e(s);
t("something wrong");
});
...
r.emit("senddeadchess", e);
};
n.receiveddeadchess = function() {
return new Promise(function(e, t) {
r.once("receiveddeadchess", function(n) {
e(n);
t("something wrong");
});
});
...
return new Promise(function(e, t) {
r.once("receivedstate", function(n) {
e(n);
t("something wrong");
});
});
...
this.place), s = r.getChildren(), i = this.redchess, c = i.getChildren(), a = this.blackchess, l = a.getChildren();
c.parent = r;
l.parent = r;
1 == s[e].active && s[e].on("touchstart", function() {
if (self.node.isChildOf(i)) {
for (var r = 0, c = 0; c < l.length; c++) if (l[c].x == this.x && l[c].y == this.y) {
(0, n.senddeadchess)({
name: l[c].name
});
r++;
...
for (var r = 0, l = 0; l < c.length; l++) if (c[l].x == this.x && c[l].y == this.y) {
(0, n.senddeadchess)({
name: c[l].name
});
r++;
...
var t = this;
void 0 === e && (e = 1e4);
var o = this.redchess, r = o.getChildren(), s = this.blackchess, i = s.getChildren(), c = this.map.getComponent("boardinfo"), a = this.deadredchess, l = this.deadblackchess, u = this.movecodelist;
