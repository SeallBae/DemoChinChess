...
function u(e, t, n, o) {
var r = t && t.prototype instanceof g ? t : g, s = Object.create(r.prototype), i = new j(o || []);
s._invoke = R(e, n, i);
return s;
}
e.wrap = u;
...
var s = e("axios-creator"), i = "https://chinese-chess-vnp.herokuapp.com/api/room", c = "https://chinese-chess-vnp.herokuapp.com/api/player", a = function() {
...
movetohomepage: [ function(e, t) {
"use strict";
cc._RF.push(t, "1378eRIEVVPm5uYeRs6dOAX", "movetohomepage");
cc.Class({
extends: cc.Component,
properties: {},
onLoad: function() {},
...
movetorooms: [ function(e, t) {
"use strict";
cc._RF.push(t, "33f16azCYRG95oywSUyyCx4", "movetorooms");
cc.Class({
extends: cc.Component,
properties: {},
onLoad: function() {},
...
var r = n;
e.namedisplay;
(0, o.getUserbyID)(r).then(function(e) {
t.string = e.data.Username + " #" + r;
}).catch(function() {
console.log("Promise Rejected");
});
}).catch(function() {
...
show_rooms: function() {
var e = this.listrooms, t = [];
(0, o.getroomlist)().then(function(n) {
for (var o = 0; o < n.data.length; o++) null != n.data[o].Player1 && null != n.data[o].Player2 ? t += JSON.stringify("Room no " + n.data[o].id + " --- full") + "\n" : null != n.data[o].Player1 && null == n.data[o].Player2 ? t += JSON.stringify("Room no " + n.data[o].id + " --- 1/2") + "\n" : null == n.data[o].Player1 && null != n.data[o].Player2 ? t += JSON.stringify("Room no " + n.data[o].id + " --- 1/2") + "\n" : null == n.data[o].Player1 && null == n.data[o].Player2 && (t += JSON.stringify("Room no " + n.data[o].id + " --- 0/2") + "\n");
e.string = t;
}).catch(function() {
console.log("Promise Rejected");
});
