...
onload: function() {},
start: function() {
PlayerInfo = this.PlayerInfo.getComponent("PlayerInfo");
},
load_scene: function() {
uid = this.uid;
var e = this.Username.string;
...
console.log("data.data.id", e.data.id);
cc.sequence(console.log(e.data.id), (0, n.senduserID)(e.data.id));
...
for (l = 0; l < i.length; l++) i[l].x == o[c].x && i[l].y == o[c].y && 1 == o[c].active && o[c].setScale(scale, scale);
}
t.redtouchmove(c);
}
},
...
var e = cc.director.getScene().getChildByName("PlayerInfo").getComponent("PlayerInfo"), t = cc.director.getScene().getChildByName("RoomInfos").getComponent("RoomInfos"), n = e.uid;
console.log("uid", n);
...
onLoad: function() {
var e = this.namedisplay, t = cc.director.getScene().getChildByName("PlayerInfo").getComponent("PlayerInfo"), n = t.uid;
fetch("https://chinese-chess-vnp.herokuapp.com/api/player/" + n, {
method: "GET",
headers: {
Accept: "application/json",
"Content-Type": "application/json"
...
e.string = n.data.Username + " #" + t.uid;
});
},
start: function() {},
onDisable: function() {
...
onLoad: function() {
var e = cc.director.getScene().getChildByName("PlayerInfo").getComponent("PlayerInfo"), t = this.id, n = e.uid;
fetch("https://chinese-chess-vnp.herokuapp.com/api/player/" + n, {
method: "GET",
headers: {
Accept: "application/json",
...
t.string = n.data.Username + " #" + e.uid;
});
},
show_rooms: function() {
...
for (var n = 0; n < t.data.length; n++) null != t.data[n].Player1 && null != t.data[n].Player2 ? list += JSON.stringify("Room no " + t.data[n].id + " --- full") + "\n" : null != t.data[n].Player1 && null == t.data[n].Player2 ? list += JSON.stringify("Room no " + t.data[n].id + " --- 1/2") + "\n" : null == t.data[n].Player1 && null != t.data[n].Player2 ? list += JSON.stringify("Room no " + t.data[n].id + " --- 1/2") + "\n" : null == t.data[n].Player1 && null == t.data[n].Player2 && (list += JSON.stringify("Room no " + t.data[n].id + " --- 0/2") + "\n");
e.string = list;
});
},
start: function() {},
...
n.__esModule = !0;
n.senduserID = n.sendroomID = n.senddeadchess = n.sendchessPosition = n.sendName = n.receiveduserID = n.receivedroomID = n.receiveddeadchess = n.receivedchessPosition = void 0;
function o(e) {
...
console.log("data " + n);
var o = n;
console.log("userID inside socketon" + o);
e(o);
t("something wrong");
});
});
...
update: function(e) {
void 0 === e && (e = 1e4);
var t = this.redchess, o = t.getChildren(), s = this.blackchess, r = s.getChildren(), i = this.map.getComponent("boardinfo"), c = this.deadredchess, a = this.deadblackchess, l = this.movecodelist;
l.string = list;
(0, n.receivedchessPosition)().then(function(e) {
for (var n = 0; n < o.length; n++) if (o[n].name == e[e.length - 1].name) {
o[n].x = e[e.length - 1].x;
o[n].y = e[e.length - 1].y;
t.pauseSystemEvents(!0);
s.resumeSystemEvents(!0);
break;
}
for (var i = 0; i < r.length; i++) if (r[i].name == e[e.length - 1].name) {
r[i].x = e[e.length - 1].x;
r[i].y = e[e.length - 1].y;
s.pauseSystemEvents(!0);
t.resumeSystemEvents(!0);
break;
}
if (0 == list.length || list[list.length - 1] !== JSON.stringify(e[e.length - 1])) {
console.log(JSON.stringify(e[e.length - 1]));
console.log("reach");
list.push(JSON.stringify(e[e.length - 1]));
}
}).then(function(e) {
l.string = JSON.stringify(e);
});
(0, n.receiveddeadchess)().then(function(e) {
for (var t = 0; t < o.length; t++) if (o[t].name == e.name) {
i.countreddead++;
o[t].setScale(.8, .8);
o[t].x = 0;
o[t].y = -30 - i.countreddead * (i.chesssize / 2);
o[t].pauseSystemEvents(!0);
o[t].parent = c;
}
for (var n = 0; n < r.length; n++) if (r[n].name == e.name) {
i.countblackdead++;
r[n].setScale(.8, .8);
r[n].x = 0;
r[n].y = -30 - i.countblackdead * (i.chesssize / 2);
r[n].pauseSystemEvents(!0);
r[n].parent = a;
}
});
}
