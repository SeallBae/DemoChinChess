...
//cjh  static void initPluginWrapper(android_app* app);
        ...
        static jobject createJavaListObject(std::vector<std::string> *paramList);
        ...
        static int callJavaIntFuncWithName_oneParam(PluginProtocol *thiz, const char *funcName, const char *paramCode, T param) {
            CALL_BASE_RET_JAVA_FUNC_WITH_PARAM(int, paramCode, param, Int, 0)
        }

        static int callJavaIntFuncWithName(PluginProtocol *thiz, const char *funcName) {
            CALL_BASE_RET_JAVA_FUNC(int, "()I", Int, 0)
        }
        ...
        static float callJavaFloatFuncWithName_oneParam(PluginProtocol *thiz, const char *funcName, const char *paramCode, T param) {
            CALL_BASE_RET_JAVA_FUNC_WITH_PARAM(float, paramCode, param, Float, 0.0f)
        }

        static float callJavaFloatFuncWithName(PluginProtocol *thiz, const char *funcName) {
            CALL_BASE_RET_JAVA_FUNC(float, "()F", Float, 0.0f);
        }
        ...
        static bool callJavaBoolFuncWithName_oneParam(PluginProtocol *thiz, const char *funcName, const char *paramCode, T param) {
            CALL_BASE_RET_JAVA_FUNC_WITH_PARAM(bool, paramCode, param, Boolean, false)
        }

        static bool callJavaBoolFuncWithName(PluginProtocol *thiz, const char *funcName) {
            CALL_BASE_RET_JAVA_FUNC(bool, "()Z", Boolean, false)
        }

        // methods return value is StringMap
        static StringMap callJavaStringMapFuncWithName(PluginProtocol *thiz, const char *funcName);

        template<typename T>
        static StringMap callJavaStringMapFuncWithName_oneParam(PluginProtocol *thiz, const char *funcName, const char *paramCode, T param);

        static void callJavaFunctionWithName_string_map(PluginProtocol *thiz, const char *funcName, const char *keyParam, StringMap *paramMap);
